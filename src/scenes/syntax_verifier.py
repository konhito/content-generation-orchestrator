...
class SyntaxVerifier:
    ...
    def verify_scenes(
        ...
        # TypeScript is authoritative. _run_typescript_syntax_check already
        # falls back to the basic checker when TypeScript is unavailable.
        all_errors = ts_errors
...
"""
        ...
        try:
            ...
            tsc_path = self.remotion_dir / "node_modules" / ".bin" / executable
            if tsc_path.exists():
