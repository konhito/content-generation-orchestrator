...
// Load fonts globally only when explicitly enabled.
// Local/headless renders should not fail because fonts.gstatic.com is blocked.
if (process.env.REMOTION_LOAD_REMOTE_FONTS === "1") {
