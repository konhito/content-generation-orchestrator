...
class TestShortGenerator:
    ...
    def test_load_short_script_reads_utf8_unicode(self, tmp_path):
        script_path = tmp_path / "short_script.json"
        script_path.write_text(
            json.dumps(
                {
                    "source_project": "unicode-short",
                    "title": "AI “hallucinations”",
                    "condensed_narration": "AI can sound “right” while being wrong.",
                    "hook_question": "Why does AI say “facts”?",
                    "scenes": [
                        {
                            "source_scene_id": "short_first_beat_1",
                            "duration_seconds": 50.0,
                        }
                    ],
                    "cta_text": "Follow for more.",
                    "cta_narration": "Follow for more.",
        ...
        assert loaded.title == "AI “hallucinations”"
        assert "“right”" in loaded.condensed_narration
